...
# This was removed since the course was recorded.
#from qiskit_algorithms import Shor

# In depth explanation and circuit code found here:
# https://github.com/qiskit-community/qiskit-community-tutorials/blob/master/algorithms/shor_algorithm.ipynb

# Also u1 was removed from Qiskit. Here is an explanation and workaround:
# https://stackoverflow.com/questions/76939147/keep-receiving-error-attributeerror-quantumcircuit-object-has-no-attribute
